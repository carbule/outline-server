...
install_shadowbox() {
  ...
  export DOCKER_USER="${DOCKER_USER:-0}"
  ...
  # readonly SB_IMAGE="${SB_IMAGE:-registry.cn-shanghai.aliyuncs.com/azhicloud/shadowbox:stable}"
  readonly SB_IMAGE="${SB_IMAGE:-azhicloud/shadowbox:stable}"
