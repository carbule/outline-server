...
```
sudo bash -c "$(wget -qO- https://raw.githubusercontent.com/carbule/outline-server/master/src/server_manager/install_scripts/install_server.sh)"
```
...
```
sudo bash -c "$(wget -qO- https://raw.githubusercontent.com/carbule/outline-server/master/src/server_manager/install_scripts/install_server.sh)" install_server.sh --hostname=myserver.com --keys-port=443
```
